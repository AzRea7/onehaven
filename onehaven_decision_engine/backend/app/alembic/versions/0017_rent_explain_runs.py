...
def upgrade() -> None:
    ...
    op.create_index("ix_rent_explain_runs_org_id", "rent_explain_runs", ["org_id"])
    op.create_index("ix_rent_explain_runs_property_id", "rent_explain_runs", ["property_id"])


def downgrade() -> None:
    op.drop_index("ix_rent_explain_runs_property_id", table_name="rent_explain_runs")
    op.drop_index("ix_rent_explain_runs_org_id", table_name="rent_explain_runs")
