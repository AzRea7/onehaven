...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("crawl_status", sa.String(length=40), nullable=False, server_default="pending"),
        sa.Column("inventory_origin", sa.String(length=40), nullable=False, server_default="discovered"),
        ...
        sa.Column("fingerprint_algo", sa.String(length=40), nullable=False, server_default="sha256"),
        ...
        sa.Column("expected_categories_json", sa.Text(), nullable=False, server_default="[]"),
        sa.Column("expected_tiers_json", sa.Text(), nullable=False, server_default="[]"),
        sa.Column("category_hints_json", sa.Text(), nullable=False, server_default="[]"),
        sa.Column("search_terms_json", sa.Text(), nullable=False, server_default="[]"),
        ...
        sa.Column("searched_not_found_count", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("inventory_metadata_json", sa.Text(), nullable=False, server_default="{}"),
    ...
    op.create_table(
        ...
        sa.Column("attempt_type", sa.String(length=40), nullable=False, server_default="discovery"),
        sa.Column("status", sa.String(length=40), nullable=False, server_default="started"),
        sa.Column("query_text", sa.Text(), nullable=True),
        sa.Column("searched_categories_json", sa.Text(), nullable=False, server_default="[]"),
        sa.Column("searched_tiers_json", sa.Text(), nullable=False, server_default="[]"),
