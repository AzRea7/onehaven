...
from app.services.inspections.failure_task_service import build_failure_next_actions
from app.services.acquisition_tag_service import list_property_tags
...
from app.services.risk_scoring import classify_deal_candidate
