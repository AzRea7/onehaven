...
def finish_run(
    ...
    *,
    ...
    if source:
        ...
        source.next_scheduled_at = row.finished_at + timedelta(minutes=mins)
...
def get_ingestion_overview(db: Session, *, org_id: int) -> dict[str, Any]:
    ...
    return {
        "sources_connected": int(sources_connected),
