...
from app.products.acquire.services.acquisition_tag_service import list_property_tags
...
from app.products.investor_intelligence.services.risk_scoring import classify_deal_candidate
