...
from app.products.acquire.services.acquisition_tag_service import list_property_tags, replace_property_tags
from app.products.acquire.services.acquisition_participant_service import list_participants
