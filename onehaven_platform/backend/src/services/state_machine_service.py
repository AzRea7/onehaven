...
from onehaven_platform.backend.src.services.inspection_failure_task_service import build_failure_next_actions
from onehaven_platform.backend.src.adapters.acquire_adapter import list_property_tags
...
from onehaven_platform.backend.src.adapters.intelligence_adapter import classify_deal_candidate
