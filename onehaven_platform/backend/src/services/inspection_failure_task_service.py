...
from onehaven_platform.backend.src.adapters.compliance_adapter import map_inspection_code
from onehaven_platform.backend.src.adapters.compliance_adapter import top_fail_points
