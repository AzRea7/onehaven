...
from onehaven_platform.backend.src.adapters.compliance_adapter import summarize_items
...
def build_property_readiness_with_schedule(
    ...
    *,
    ...
    """
    from onehaven_platform.backend.src.adapters.compliance_adapter import build_property_schedule_summary
