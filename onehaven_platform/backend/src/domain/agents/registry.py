...
from onehaven_platform.backend.src.models import Deal, Property, PropertyState
...
try:
    from onehaven_platform.backend.src.adapters.compliance_adapter import recompute_and_persist as trust_recompute_and_persist
except Exception:  # pragma: no cover
