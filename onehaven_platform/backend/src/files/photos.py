...
from onehaven_platform.backend.src.schemas import PropertyPhotoCreate, PropertyPhotoOut
from onehaven_platform.backend.src.adapters.compliance_adapter import create_compliance_document_from_path
