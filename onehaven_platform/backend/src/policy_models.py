...
from onehaven_platform.backend.src.db import Base
...
class JurisdictionProfile(Base):
    ...
    missing_categories_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
    stale_categories_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
    inferred_categories_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
    conflicting_categories_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
    required_categories_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
    covered_categories_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
    ...
    unmet_categories_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
    undiscovered_categories_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
    weak_support_categories_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
    authority_unmet_categories_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
...
class JurisdictionCoverageStatus(Base):
    ...
    category_coverage_snapshot_json: Mapped[dict | None] = mapped_column(JSONB, nullable=False, default=dict)
    category_last_verified_json: Mapped[dict | None] = mapped_column(JSONB, nullable=False, default=dict)
    category_source_backing_json: Mapped[dict | None] = mapped_column(JSONB, nullable=False, default=dict)
    completeness_snapshot_json: Mapped[dict | None] = mapped_column(JSONB, nullable=False, default=dict)
    expected_rule_universe_json: Mapped[dict | None] = mapped_column(JSONB, nullable=False, default=dict)
    category_coverage_details_json: Mapped[dict | None] = mapped_column(JSONB, nullable=False, default=dict)
    category_unmet_reasons_json: Mapped[dict | None] = mapped_column(JSONB, nullable=False, default=dict)
    ...
    source_ids_json: Mapped[list | None] = mapped_column(JSONB, nullable=False, default=list)
    source_summary_json: Mapped[dict | None] = mapped_column(JSONB, nullable=False, default=dict)
    source_freshness_json: Mapped[dict | None] = mapped_column(JSONB, nullable=False, default=dict)
    ...
    production_readiness: Mapped[str] = mapped_column(String(40), nullable=False, default="not_ready")
    discovery_status: Mapped[str] = mapped_column(String(40), nullable=False, default="not_started")
