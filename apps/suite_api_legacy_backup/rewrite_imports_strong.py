...
ABSOLUTE_MAP = {
    # domain
    "app.domain.jurisdiction_defaults": "onehaven_platform.backend.src.domain.policy.defaults",
    "app.domain.jurisdiction_categories": "onehaven_platform.backend.src.domain.policy.categories",
    "app.domain.policy_authority": "onehaven_platform.backend.src.domain.policy.authority",
    "app.domain.policy_decisions": "onehaven_platform.backend.src.domain.policy.decisions",
    "app.domain.policy_conflicts": "onehaven_platform.backend.src.domain.policy.conflicts",
    "app.domain.policy_evidence": "onehaven_platform.backend.src.domain.policy.evidence",
    "app.domain.policy_materiality": "onehaven_platform.backend.src.domain.policy.materiality",
    "app.domain.policy_expected_universe": "onehaven_platform.backend.src.domain.policy.expected_universe",
...
FLAT_SERVICE_MAP = {
    ...
    "jurisdiction_profile_service": "products.compliance.backend.src.services.jurisdiction_profile_service",
    "market_sync_service": "products.intelligence.backend.src.services.market_sync_service",
    "ingestion_scheduler_service": "products.acquire.backend.src.services.ingestion_scheduler_service",
    "compliance_service": "app.services.compliance_service",
    "compliance_document_service": "app.services.compliance_document_service",
    "jurisdiction_task_mapper": "products.compliance.backend.src.services.jurisdiction_task_mapper",
    "risk_scoring": "app.services.risk_scoring",  
}

FLAT_DOMAIN_MAP = {
    "jurisdiction_defaults": "onehaven_platform.backend.src.domain.policy.defaults",
    "jurisdiction_categories": "onehaven_platform.backend.src.domain.policy.categories",
    "policy_authority": "onehaven_platform.backend.src.domain.policy.authority",
    "policy_decisions": "onehaven_platform.backend.src.domain.policy.decisions",
    "policy_conflicts": "onehaven_platform.backend.src.domain.policy.conflicts",
    "policy_evidence": "onehaven_platform.backend.src.domain.policy.evidence",
    "policy_materiality": "onehaven_platform.backend.src.domain.policy.materiality",
    "policy_expected_universe": "onehaven_platform.backend.src.domain.policy.expected_universe",
}
