...
def lock_mocks(monkeypatch, lock_state):
    ...
    monkeypatch.setattr("products.acquire.backend.src.services.ingestion_run_execute.release_lock", _release)
...
def fake_post_pipeline(monkeypatch):
    ...
    monkeypatch.setattr(
        "products.acquire.backend.src.services.ingestion_run_execute.execute_post_ingestion_pipeline",
        _ok,
    )
