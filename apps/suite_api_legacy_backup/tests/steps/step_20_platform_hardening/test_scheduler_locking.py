...
def test_lock_blocks_concurrent_execution_for_same_org_and_source(
    ...
    monkeypatch.setattr("products.acquire.backend.src.services.ingestion_run_execute.acquire_ingestion_execution_lock", _acquire)
    monkeypatch.setattr("products.acquire.backend.src.services.ingestion_run_execute.release_lock", lambda *a, **k: True)
    monkeypatch.setattr("products.acquire.backend.src.services.ingestion_run_execute.has_completed_ingestion_dataset", lambda *a, **k: False)
    monkeypatch.setattr("products.acquire.backend.src.services.ingestion_run_execute.mark_ingestion_dataset_completed", lambda *a, **k: True)
...
def test_completed_dataset_marker_allows_duplicate_safe_short_circuit(
    ...
    monkeypatch.setattr("products.acquire.backend.src.services.ingestion_run_execute.acquire_ingestion_execution_lock", lambda *a, **k: True)
    monkeypatch.setattr("products.acquire.backend.src.services.ingestion_run_execute.release_lock", lambda *a, **k: True)
    ...
    monkeypatch.setattr("products.acquire.backend.src.services.ingestion_run_execute.has_completed_ingestion_dataset", _has_completed)
    monkeypatch.setattr("products.acquire.backend.src.services.ingestion_run_execute.mark_ingestion_dataset_completed", _mark_completed)
