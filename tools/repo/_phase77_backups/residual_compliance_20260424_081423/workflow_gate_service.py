...
from products.compliance.backend.src.services.compliance_engine.projection_service import build_property_projection_snapshot
from products.ops.backend.src.services.properties.state_machine import get_state_payload, get_transition_payload
