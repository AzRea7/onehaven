...
from products.compliance.backend.src.domain.compliance.photo_to_hqs_mapper import (
    PHOTO_RULE_MAPPINGS,
    PhotoRuleMapping,
    mapping_for_rule_code,
)
from app.models import Inspection, Property, PropertyPhoto, RehabTask
from products.ops.backend.src.services.property_photo_service import list_property_photos
