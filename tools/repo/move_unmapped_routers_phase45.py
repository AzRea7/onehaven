...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Move newly mapped legacy routers from Phase 44.")
...
def main() -> None:
    ...
    for review in report.get("reviews", []):
        ...
        target = review["suggested_target"]
        owner = review["owner"]
    ...
    out = repo_root / "tools" / "repo" / "unmapped-routers-phase45-report.json"
    ...
    print("Report written to tools/repo/unmapped-routers-phase45-report.json")
