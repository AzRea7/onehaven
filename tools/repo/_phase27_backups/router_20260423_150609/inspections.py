...
from app.products.compliance.services.compliance_service import apply_inspection_form_results
...
from products.compliance.backend.src.services.inspections.readiness_service import build_property_readiness_summary
...
def inspection_template_preview(
    ...
    from products.compliance.backend.src.services.inspections.template_service import build_inspection_template
...
def inspection_task_preview(
    ...
    from products.compliance.backend.src.services.inspections.failure_task_service import collect_failure_task_blueprints
