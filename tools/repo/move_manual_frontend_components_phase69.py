...
PHASE64_REPORT = "tools/repo/manual-frontend-components-phase68-report.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Move mapped frontend components from Phase 64.")
...
def main() -> None:
    ...
    report = read_json(repo_root / PHASE64_REPORT)
    ...
    out = repo_root / "tools" / "repo" / "frontend-components-phase65-report.json"
    ...
    print("Report written to tools/repo/frontend-components-phase65-report.json")
