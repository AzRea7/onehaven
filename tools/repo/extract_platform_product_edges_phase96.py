...
IN = Path("tools/repo/cross-owner-analysis-phase92-report.json")
OUT = Path("tools/repo/platform-product-edges-phase96-report.json")
...
def main():
    ...
    payload = {
        "phase": 96,
        "summary": {
            "platform_to_product_edges": len(platform_edges),
            "files": len(by_file),
    ...
    print("Report written to tools/repo/platform-product-edges-phase96-report.json")
