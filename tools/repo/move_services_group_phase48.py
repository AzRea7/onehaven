...
PHASE47_REPORT = "tools/repo/services-group-phase47-report.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Move mapped backend/app/services files from Phase 47.")
...
def main() -> None:
    ...
    report = read_json(repo_root / PHASE47_REPORT)
    ...
    out = repo_root / "tools" / "repo" / "services-group-phase48-report.json"
    ...
    print("Report written to tools/repo/services-group-phase48-report.json")
