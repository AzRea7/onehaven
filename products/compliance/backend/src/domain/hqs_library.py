...
from onehaven_platform.backend.src.policy_models import HqsAddendum, HqsRule
...
def _safe_import_nspire_service():
    try:
        from products.compliance.backend.src.services.inspections.import_nspire_service import list_active_nspire_rules
