...
from products.compliance.backend.src.domain.compliance import compliance_stats, top_fail_points
...
from products.compliance.backend.src.services.compliance_service import apply_inspection_form_results
...
def inspection_task_preview(
    ...
    from onehaven_platform.backend.src.services.inspection_failure_task_service import collect_failure_task_blueprints
