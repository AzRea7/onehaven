...
def inspection_template_preview(
    ...
    from app.products.compliance.services.inspections.template_service import build_inspection_template
...
def inspection_task_preview(
    ...
    from app.products.compliance.services.inspections.failure_task_service import collect_failure_task_blueprints
