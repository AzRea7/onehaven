...
from onehaven_platform.backend.src.models import Property, RentAssumption
from products.intelligence.backend.src.services.rent_refresh_queue_service import publish_without_rent, should_run_inline_rent_refresh
from products.intelligence.backend.src.services.rentcast_service import RentCastClient, persist_rentcast_comps_and_get_median
...
def execute_post_ingestion_pipeline(
    ...
    *,
    ...
    try:
        from products.intelligence.backend.src.routers.evaluate import evaluate_property_core
