...
from products.acquire.backend.src.services.acquisition_deadline_service import upsert_deadline_by_code
from products.acquire.backend.src.services.acquisition_participant_service import upsert_participant
...
def create_field_suggestions_from_document(
    ...
    *,
    ...
    from products.acquire.backend.src.services.acquisition_service import ensure_acquisition_record
