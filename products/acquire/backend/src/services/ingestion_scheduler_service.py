...
from products.acquire.backend.src.services.ingestion_source_service import ensure_default_manual_sources, list_sources
...
def dispatch_daily_sync_for_org(
    ...
    *,
    ...
    from products.intelligence.backend.src.services.market_sync_service import build_market_runtime_payload, get_or_create_market_sync_state
