...
from onehaven_platform.backend.src.models import Property, Deal, RentAssumption
from products.compliance.backend.src.services.jurisdiction_profile_service import resolve_jurisdiction_profile
